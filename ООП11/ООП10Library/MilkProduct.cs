...
namespace ООП10Library
{
    public class MilkProduct : Product, ICloneable, IComparable
    {
        ...
        public MilkProduct(string name, decimal price, int amountGoods, string composition, int expirationDate, bool isNoLactose, bool isNoMilkFat) : base(name, price, amountGoods, composition, expirationDate)
        {
        ...
        {
            return base.ToString() + $"{IsNoLactose,-6}{IsNoMilkFat,-6}";
        }
