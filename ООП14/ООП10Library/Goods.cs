...
namespace ООП10Library
{
    public class Goods : IInit, ICloneable, IComparable
    {
        ...
        public Goods(string name, decimal price, int amountGoods)
        {
            Name = name;
            Price = price;
        ...
        {
            return $"{Name,-15} {Price.ToString("F2", CultureInfo.InvariantCulture),-7}руб.     {AmountGoods,-6}шт.     {string.Join(", ", ReferenceType)}";
        }
        public override string ToString()
        {
            return $"{Name,-15} {Price.ToString("F2", CultureInfo.InvariantCulture),-7}руб.     {AmountGoods,-6}шт.     ";
        }
        ...
        public virtual void Init()
        {
            ...
            do
            {
                try
                {
                    ...
                    Price = UserInput.InputNumber(decimal.Parse);
                    break;
                }
