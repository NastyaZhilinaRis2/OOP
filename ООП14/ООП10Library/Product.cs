...
namespace ООП10Library
{
    public class Product : Goods, ICloneable, IComparable
    {
        ...
        public Product(string name, decimal price, int amountGoods, string composition, int expirationDate) : base(name, price, amountGoods)
        {
        ...
        {
            return base.ToString() + $"{Composition,-20}{ExpirationDate,-4}дня(ей)      "; ;
        }
